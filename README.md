...
QMK Driver To Add Sound To A [ZodiarkPi](https://www.splitlogic.xyz/shop/splitlogic/p/zodiarkpi) / QMK I<sup>2</sup>C Keyboard Using The [SparkFun Qwiic Buzzer BOB-24474](https://www.sparkfun.com/sparkfun-qwiic-buzzer.html) 
...
### Prerequisites
***Note*** You can _**not**_ use a dual axis encoder with this setup, since it uses the extra ZodiarkPi I<sup>2</sup>C pins
